...
InetAddress::InetAddress(const std::string& hostname, const int port, const sa_family_t family)
:	_hostname(hostname),
...
std::string		InetAddress::_get_hostname_of_addr(const struct sockaddr* addr, const socklen_t addr_len)
{
...
std::string		InetAddress::_get_ip_of_addr4(const struct in_addr& addr) throw (std::logic_error)
{
...
std::string		InetAddress::_get_ip_of_addr6(const struct in6_addr& addr) throw (std::logic_error)
{
