...
// ClientConnection::ClientConnection(IGatewayInterface<Side::CLIENT> *const interface, const std::string& ip_address, const int port, const sa_family_t family)
...
// IGatewayInterface<Side::CLIENT>*	ClientConnection::getInterface()
// {
